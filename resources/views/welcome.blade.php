...
<body class="antialiased">
    ...
    <div class="text-center bg-purple">Box</div>
    <div class="text-center bg-pink">Box</div>
    <div class="text-center bg-primary">Box</div>
    <a href="https://laravel.com/docs"><button class='btn btn-default bg-primary'>Docs</button></a>
