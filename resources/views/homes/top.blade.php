...
@section('main')
    ...
    <section class="py-5">
        <div class="text-center">
            <button type="button" id="dailybtn" class="btn"
                style="background-color:#DDDDDD">日別上映スケジュール<br>鑑賞の日程が決まっている方はこちら</button>
            <button type="button" id="weeklybtn" class="btn btn-dark">週別上映スケジュール<br>鑑賞の日程が決まっていない方はこちら</button>
        </div>


        <div style="background-color:#DDDDDD">
            <div class="panels">
                <div class="container dailytab" id="dailytab" style="">
                                            ...
                                            <div class="row">
                                                ...
                                                @foreach ($screeningTimeList as $screeningTime)
                                                    ...
                                                    <div class=" col-2 px-0" style="border: solid; border-color:#808080;">
                                                        <div style="background-color: #808080" class="w-100 py-2">シアター１
                                                        </div>
                ...
                <div class="container weeklytab" id="weeklytab" style="display: none">
